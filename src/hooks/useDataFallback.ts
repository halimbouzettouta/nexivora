...
const FALLBACK_ARTICLES = [
  { id: 1, slug: 'choosing-your-first-e-bike', title: 'Choosing Your First E-Bike: A Complete Guide', excerpt: 'Everything you need to know before buying your first electric bike in Algeria. From motor types to battery range, we cover it all.', category: 'Guides', readTime: 8, date: '2025-05-15', publishedAt: '2025-05-15', featuredImage: '/article-guide.jpg', content: 'Electric bikes are transforming how Algerians commute...' },
  ...
  { id: 3, slug: 'algeria-electric-revolution', title: "Algeria's Electric Mobility Revolution", excerpt: 'How electric bikes and scooters are changing urban transportation across Algerian cities.', category: 'Industry News', readTime: 6, date: '2025-04-28', publishedAt: '2025-04-28', featuredImage: '/article-industry.jpg', content: 'From Algiers to Oran, electric two-wheelers are becoming...' },
