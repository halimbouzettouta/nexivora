...
const botResponses: Record<string, string[]> = {
  en: {
    greeting: ["Hello! Welcome to Nexivora Algeria. How can I help you today?"],
    ...
    contact: ["You can reach us at contact@nexivora-dz.com or call +213 555 123 456. Our team is available Sun-Thu, 9AM-6PM."],
  ...
  ar: {
    greeting: ["مرحباً! أهلاً بك في إي-رايد الجزائر. كيف يمكنني مساعدتك؟"],
    ...
    contact: ["يمكنك التواصل معنا على contact@nexivora-dz.com أو الاتصال على +213 555 123 456. فريقنا متاح من الأحد إلى الخميس."],
  ...
  fr: {
    greeting: ["Bonjour ! Bienvenue chez Nexivora Algérie. Comment puis-je vous aider ?"],
    ...
    contact: ["Contactez-nous à contact@nexivora-dz.com ou appelez le +213 555 123 456. Notre équipe est disponible dim-jeu, 9h-18h."],
